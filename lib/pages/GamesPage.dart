                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: () async {
                                              ...
                                              await gameController.edit(gameController.games[index].id!, widget.currentPlayer.id!, gameCurrent);
                      ...
                      TextButton(
                        ...
                        onPressed: () async {
                          await gameController.delete(widget.currentPlayer.id!, gameController.games[index].id!);
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              await gameController.create(gameCurrent, widget.currentPlayer.id!);
                              ScaffoldMessenger.of(context)
                                .showSnackBar(SnackBar(
                                  content: Text(
                                    'Salvo com sucesso!'
